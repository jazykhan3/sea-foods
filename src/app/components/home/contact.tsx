  ...
  return (
    <>
      <div className="flex flex-col w-full justify-center items-center">
                    ...
                    <div className="flex flex-wrap gap-3 lg:gap-4 justify-start items-start w-full">
                      ...
                      >
                        <Image
                          ...
                          alt={`${
                            selectedSubject === 0 ? "_selected" : "_unselected"
                          }`}
                          width={15}
                          height={15}
                      ...
                      >
                        <Image
                          ...
                          alt={`${
                            selectedSubject === 1 ? "_selected" : "_unselected"
                          }`}
                          width={15}
                          height={15}
                          className="max-w-[15px] max-h-[15px] w-full h-full cursor-pointer"
                      ...
                      >
                        <Image
                          ...
                          alt={`${
                            selectedSubject === 2 ? "_selected" : "_unselected"
                          }`}
                          width={15}
                          height={15}
                          className="max-w-[15px] max-h-[15px] w-full h-full cursor-pointer"
                      ...
                      >
                        <Image
                          ...
                          alt={`${
                            selectedSubject === 3 ? "_selected" : "_unselected"
                          }`}
                          width={15}
                          height={15}
                          className="max-w-[15px] max-h-[15px] w-full h-full cursor-pointer"
        ...
        <div className="w-full h-[100px] bg-gradient-to-t from-[#DDEEFF] to-[#DDEEFF00] -mt-[90px]"></div>
      </div>
    </>
  );
};
